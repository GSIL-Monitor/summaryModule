...
<header class="main-header">
        <!-- Logo -->
        <a href="${basePath}/BriefIntroduction/BriefIntroduction" class="logo">
            <!-- mini logo for sidebar mini 50x50 pixels -->
            <span class="logo-mini"><img src="../../static/img/logo.png" width="30px" height="23px"></span>
            <!-- logo for regular state and mobile devices -->
            <div class="logo-lg">
                <img src="../../static/img/logo.png" width="30px" height="23px">
                <span>盛誉</span>
            </div>
        </a>
